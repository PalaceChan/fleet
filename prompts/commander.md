...
user in the same one-message form as your own, then relay the answer per task; `progress` you note (one
that names tasks carries results the lieutenant verified; the request stays open until `settled`); a
